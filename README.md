<h1 align="center">Hi 👋, I'm Rayu</h1>
<h3 align="center">Computing Science Student at University of Alberta, Alberta🌟.</h3>
<h4 align='center'>Full-Stack Developer | React • Node.js • Systems Automation • DevOps Workflow</h4>

## About me
I am a Fullstack Developer dedicated to the intersection of high-performance interfaces and automated infrastructure. While I specialize in building scalable UIs with React and TypeScript, my focus extends far beyond the browser.

I treat the entire application lifecycle as a single cohesive unit. I ensure that the environments hosting my code are as performant and secure as the components themselves. From hardening Linux servers to optimizing React rendering patterns, I deliver stable, testable, and production-ready solutions that scale.

## Technical Skills & Tools

**Fullstack Core:** React • TypeScript • Node.js (Express) • MongoDB • Supabase • PostgreSQL

**Systems & Automation:** Python • Bash • Linux System Administration • Tailscale • N8N 

**DevOps & Cloud IaC:** Docker • Nginx • Caddy • CI/CD (GitHub/GitLab) • AWS • Proxmox

**Quality & Performance:** Jest • Vitest • Playwright • React Testing Library • Supertest • Debugging • Perf. Optimization
...
<a href = "https://www.vim.org/" target = "_blank"><img src = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Vimlogo.svg/1022px-Vimlogo.svg.png" alt="vim" width="40"  height="40"/></a>
